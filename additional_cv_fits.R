...
saveRDS(cv_id_cmaq_spat, "fits/cv_id_cmaq_spat.rds")
saveRDS(cv_id_aod_spat, "fits/cv_id_aod_spat.rds")
...
saveRDS(cv_id_cmaq_spatclust, "fits/cv_id_cmaq_spatclust.rds")
saveRDS(cv_id_aod_spatclust, "fits/cv_id_aod_spatclust.rds")
...
saveRDS(cv_id_cmaq_spatbuff3, "fits/cv_id_cmaq_spatbuff3.rds")
saveRDS(cv_id_aod_spatbuff3, "fits/cv_id_aod_spatbuff3.rds")
...
saveRDS(cv_id_cmaq_spatbuff7, "fits/cv_id_cmaq_spatbuff7.rds")
saveRDS(cv_id_aod_spatbuff7, "fits/cv_id_aod_spatbuff7.rds")
